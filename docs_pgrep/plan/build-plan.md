...
- **L2.7.4 Identity groundwork.** Produce the app icon from `design/assets/reference/logo.png` (the `.icns` set and the smaller glyphs), and set the development window and menu title to pgrep. Final bundle id and installer name stay at L6. Owns: `qt/aqt/` icon and title wiring, icon assets.
