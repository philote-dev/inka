...
- [`plan/content-foundry-and-verifier-design.md`](plan/content-foundry-and-verifier-design.md) — verification-guided content foundry design (calibrated panel, best-of-N loop); **status board** and implemented WS10 generation circuit breaker.
