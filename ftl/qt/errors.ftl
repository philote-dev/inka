...
errors-addons-active-popup =
    ...
    An error occurred. Please start pgrep while holding down the shift key,
    ...
    Tools > Add-ons menu item to disable some add-ons and restart pgrep,
...
errors-accessing-db =
    ...
    interfering with pgrep. Try disabling such software and see if the
    problem goes away.
